let header: string = '<div class="head contaner">'+
      '<a href="./index.html">'+
...
// Mobile menu
let imgOpen = <HTMLElement> <unknown> document.querySelector('.humborger')
let imgClose = <HTMLElement> <unknown>document.querySelectorAll('.close')
let ul = <HTMLElement> <unknown>document.querySelectorAll('.ul-con')
